...
RUSSIAN_RULES = {
    ...
    "жи ши": {
        ...
        "rule": "После Ж и Ш всегда пишется буква И (а не Ы).",
        "example": "жираф, шишка, машина."
    },
    "ча ща": {
        "title": "✍️ Правописание ЧА-ЩА",
        "rule": "После Ч и Щ всегда пишется буква А (а не Я).",
        "example": "чашка, задача, щавель."
    },
    "чу щу": {
        "title": "✍️ Правописание ЧУ-ЩУ",
        "rule": "После Ч и Щ всегда пишется буква У (а не Ю).",
        "example": "чудо, щука, ищу."
    },
    "времена глаголов": {
        "title": "⚡ Времена глаголов",
        "rule": "Глаголы имеют три времени: прошедшее, настоящее и будущее.",
        "example": "Он писал (прош.), пишет (наст.), будет писать (буд.)."
    }
}

def clean_text(text: str) -> str:
    """Очистка текста: убираем эмодзи, лишние символы и приводим к нижнему регистру"""
